"""Compile/run the actual v1.09 sketch against deterministic host hardware fakes.

Usage: python tests/run_v109_tests.py --compiler /path/to/zig.exe
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='stepper-v109-tests-') as directory:
        ...
        shutil.copyfile(ROOT / 'stepper_speedometer_v1_09.ino', build / 'firmware.ino')
        shutil.copyfile(ROOT / 'tests/v109_logic.cpp', build / 'test.cpp')
