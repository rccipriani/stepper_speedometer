"""Compile/run the actual v1.11 sketch against deterministic host hardware fakes.

Usage: python tests/run_v111_tests.py --compiler /path/to/zig.exe
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='stepper-v111-tests-') as directory:
        ...
        firmware = (ROOT / 'stepper_speedometer_v1_11.ino').read_text()
        ...
        shutil.copyfile(ROOT / 'tests/v111_logic.cpp', build / 'test.cpp')
