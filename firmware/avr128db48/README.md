...
* 4000 pulses/mile, ratio 500â€“2000 in thousandths, 3-second stop timeout,
  period aging, independent pulse-count distance, fractional remainders and rollovers.
* Gauge mapping `mph * 5.1 + offset`, offset âˆ’60â€¦60, rounded/clamped to 0â€¦510
...
* State schema 1: 32-byte payload plus commit byte at 0x80/0xC0. Layout schema 1:
  ...
  migration reads 0x00â€“0x31 without modifying those bytes. CRC and commit order
